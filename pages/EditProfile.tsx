    ...
    <div className="min-h-screen bg-luxe-black p-6 md:pl-32 max-w-2xl mx-auto pb-32">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in">
        ...
        <div className="pt-10">
          <button 
            type="submit"
            className="w-full py-5 bg-gradient-to-r from-gold-600 via-gold-400 to-gold-600 text-black font-black uppercase tracking-[0.3em] rounded-full shadow-2xl shadow-gold-500/20 active:scale-[0.98] transition-all"
          >
            変更を保存する
          </button>
